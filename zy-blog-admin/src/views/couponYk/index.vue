    ...
    methods: {
      getPerms() {
        ...
        if (perms.includes('*')) {
          ...
          if (perms.includes('POST /admin/couponConsumeListYk')) {
            this.listButton = true;
          }
      ...
      getList() {
        ...
        this.loading = true
        this.request('api_admin_coupon_listYk', this.queryList).then((res) => {
          this.tableData = res;
          this.loading = false
        }).catch((error) => {
          this.loading = false
      ...
      doExcelExport() {
        ...
        this.loading = true
        this.request('api_admin_coupon_exportYk', this.queryList).then((res) => {
          this.loading = false
        }).catch((error) => {
          this.loading = false
        });
