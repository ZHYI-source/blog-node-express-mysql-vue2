...
var date = []
var estimate = []
var real = [8.3, 7.5, 8.9, 7.5, 7.3, 9.1, 8.6]
...
export default {
  ...
  methods: {
    initChart() {
      ...
      for (var i = 0; i < 33; i++) {
        var estimateItem = (real[i]+0.3)/ 100; //计算计划量比率
    ...
    setOptions({ date, estimate,real } = {}) {
      this.chart.setOption({
        ...
        series: [{
          name: '预计出行量(万)', //曲线展示设置  name要和legend对应
          type: 'line',
          smooth: true,
          showAllSymbol: true,
