...
<template>
  <div class="app-table">
    ...
    <el-dialog title="选择发送机构" :visible.sync="sendForm" width="45%" v-loading="sendLoading"
    ...
    <el-dialog title="历史记录" :visible.sync="historyForm" width="900px" style="align-items: center;align-content: center">
      <el-table v-loading="historyLoading" :data="historyList.records" element-loading-text="正在查询中。。。"
        ...
        <el-table-column label="接收机构" width="600px" align="center">
          <template slot-scope="{row}">
      ...
      <pagination v-show="historyList.total > 0" :total="historyList.total" :page.sync="historyList.current"
                  :limit.sync="historyList.size" @pagination="historyData" style="margin-top: -20px; margin-bottom: -20px"/>
        <div slot="footer" class="dialog-footer">
  ...
  export default {
    ...
    methods: {
      ...
      handleSend(row){
        ...
        this.sendForm = true
        // this.orgData = this.generateData
      },
      sendData(){
