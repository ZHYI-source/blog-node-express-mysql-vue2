    ...
    <section>
      ...
      >
        ...
        <el-form-item class="inline-item" prop="idCard">
          <el-input v-model.trim="query.params.idCard" clearable placeholder="输入业务流水搜索" size="mini"
                    @clear="goPage(1)" @keyup.enter.native="goPage(1)"
          ></el-input>
        </el-form-item>
        ...
        <el-form-item class="inline-item" prop="phone">
          <el-select v-model="query.params.phone" placeholder="请选择" clearable  size="mini"
                     @clear="goPage(1)" @keyup.enter.native="goPage(1)">
            <el-option key="全部" label="全部" value="0"></el-option>
            <el-option key="借方" label="借方" value="1"></el-option>
            <el-option key="贷方" label="贷方" value="2"></el-option>
          </el-select>
        </el-form-item>
      ...
      <lk-el-table :key="updataKey" :datas="datas" stripe :height="tableHeight" :loadingText="loading.text" :loading="loading.list">
...
import ViewAccountChecking from "@/views/zzPages/account/view-account-checking";

export default {
  name: 'dir-account-checking',
  components: {
    ViewAccountChecking,
    GetEmployeeInfo,
    ViewEmployeeInfo,
  ...
  data() {
    return {
      ...
      datas: [
        {
          ...
          2:'1475290303209709570',
          3:'张斌易',
          4:'2021/11/02 14:29:17',
          12:'**** **** **** 7468',
          ...
          8:'张斌易',
          9:'17785828441',
          10:'520103197102094014',
          11:'-',
          13:'2022-01-02 18:23:33',
        }
      ],
      //临时变量
      temp: {
      ...
      //列表渲染数据列
      fields: [
        {key: '1', name: '业务流水', show: true, width: '180', enableSort: false, align: "center", fixed: false},
        {key: '2', name: '用工ID', show: true, width: '180', enableSort: false, align: "center", fixed: false},
        {key: '3', name: '户名', show: true, width: '', enableSort: false, align: "center", fixed: false},
        {key: '12', name: '银行卡号', show: true, width: '', enableSort: false, align: "center", fixed: false},
        {key: '4', name: '创建时间', show: true, width: '', enableSort: false, align: "center", fixed: false},
        {key: '5', name: '完成时间', show: true, width: '', enableSort: false, align: "center", fixed: false},
        {key: '6', name: '交易金额', show: true, width: '', enableSort: false, align: "center", fixed: false},
        {key: '7', name: '交易状态', show: true, width: '', enableSort: false, align: "center", fixed: false},
        {key: '8', name: '用户姓名', show: true, width: '', enableSort: false, align: "center", fixed: false},
        {key: '9', name: '手机号', show: true, width: '', enableSort: false, align: "center", fixed: false},
        {key: '10', name: '身份证号', show: true, width: '', enableSort: false, align: "center", fixed: false},
        {key: '11', name: '电子回单', show: true, width: '', enableSort: false, align: "center", fixed: false},
  ...
  methods: {
    ...
    goView(data) {
      let datas = data ? data : {};
      this.toast.showSmallModal('对账详情', ViewAccountChecking, {datas})
    },
    //下载用户模板
    getExample() {
      let params = {};
