  ...
  <section>
    <section class="view-box">
      <section class="task-info">
        <mk-view-row>
          <mk-view-item title="分类名称" label-width="70">
            {{ form.sort_name}}
          </mk-view-item>
        </mk-view-row>
        <mk-view-row>
        ...
        <mk-view-row>
          <mk-view-item title="分类描述" label-width="70">
            <el-input
              style="width: 450px"
              type="textarea"
              :rows="2"
              disabled
              v-model="form.sort_desc">
            </el-input>
...
import MkViewTextarea from "@/components/common/mk-view-textarea";
/**
 *@author ZY
 *@date 2021/12/9
 *@Description:文章分类详情
